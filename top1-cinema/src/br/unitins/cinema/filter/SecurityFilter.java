package br.unitins.cinema.filter;
...
public class SecurityFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (usuario == null) {
			((HttpServletResponse) response).sendRedirect("/CrudCinema/faces/login.xhtml");
		}  else {
			...
			((HttpServletResponse) response).sendRedirect("/CrudCinema/faces/acessonegado.xhtml");
