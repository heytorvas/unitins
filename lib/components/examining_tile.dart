...
import 'package:frite/pages/update_examining_page.dart';
...
class _ExaminingTileState extends State<ExaminingTile> {
  delete() async {
    ...
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => ExaminingList()));
  }
              ...
              builder: (ctx) => AlertDialog(
                    ...
                    content: Column(
                      ...
                      children: [
                        ...
                        Text(
                            'Data de Nascimento: ${widget.examining.birthDate}'),
          ...
          child: Row(
            children: <Widget>[
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context, MaterialPageRoute(builder: (context) => UpdateExamining(examining: widget.examining,)));
                },
              ),
              IconButton(
